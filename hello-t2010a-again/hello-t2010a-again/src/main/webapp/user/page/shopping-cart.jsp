<%@ page import="com.t2010a.hellot2010aagain.entity.shoppingcart.ShoppingCart" %>
<%@ page import="com.t2010a.hellot2010aagain.entity.shoppingcart.CartItem" %>
                        ...
                        <tr>
                            <td class="product__cart__item">
                                <div class="product__cart__item__pic">
                                    <img width="90px" src="<%=items.get(i).getProductThumbnail()%>" alt="">
                                </div>
                                <div class="product__cart__item__text">
                                    <h6><%=items.get(i).getProductName()%></h6>
                            ...
                            <td class="quantity__item">
                                <div class="quantity">
                                    <div class="pro-qty-2">
                                        <input class="product-quantity" type="text" value="<%=items.get(i).getQuantity()%>">
                                        <input class="product-id" type="hidden" value="<%=items.get(i).getProductId()%>">
                                    </div>
                                </div>
                            </td>
                            <td class="cart__price"><%=items.get(i).getUnitPrice()%> VND</td>
...
<script>
    document.addEventListener("DOMContentLoaded", function (){
        $('.fa-angle-left').click(function (){
            console.log($(this));
            console.log($(this).closest('.pro-qty-2').select('product-id').attr('value'));
            console.log($(this).closest('.pro-qty-2').select('product-quantity').attr('value'));
        });
